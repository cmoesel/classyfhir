...
const BaseStructureDefinition = require('../src/BaseStructureDefinition');

// Placeholder test
describe('#BaseStructureDefinition()', () => {
  it('should get extensions by URL', () => {
    ...
    const bsd = new BaseStructureDefinition(json.entry[0].resource);
